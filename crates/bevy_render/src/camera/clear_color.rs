...
/// For [`Camera.clear_color`], specifies the color used to clear the viewport before rendering.
///
...
/// A [`Resource`] that stores the default color that is used to clear the screen between frames.
///
/// This color appears as the "background" color for simple apps,
/// when there are portions of the screen with nothing rendered.
///
/// Individual cameras may use a different clear color if specified via
/// [`Camera.clear_color`].
///
/// [`Camera.clear_color`]: crate::camera::Camera::clear_color
